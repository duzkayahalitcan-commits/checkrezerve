...
/**
 * WhatsApp destek float butonu.
 * Yalnızca iletişim sayfasında kullanılır (diğer sayfalarda buton kalabalığı
 * oluşturmamak için global layout'tan kaldırıldı — bakınız: S5 notu).
 */
