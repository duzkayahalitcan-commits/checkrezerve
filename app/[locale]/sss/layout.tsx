...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Sıkça Sorulan Sorular', description: 'CheckRezerve online rezervasyon ve randevu sistemi hakkında sık sorulan sorular: fiyatlandırma, kurulum, SMS/WhatsApp bildirimleri, KVKK.' },
}
