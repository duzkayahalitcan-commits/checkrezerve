...
export default async function AyarlarPage({
  ...
  const { data: restaurant } = await db
    .from('restaurants')
    .select('id, name, slug, address, capacity, working_hours, closed_dates, prepayment_amount, special_notes, dress_code, ai_assistant_enabled, ai_assistant_name, ai_assistant_voice')
    .eq('slug', slug)
